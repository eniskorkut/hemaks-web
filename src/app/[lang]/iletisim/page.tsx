...
export default async function ContactPage({ params }: Props) {
  ...
  // ✅ KESİN HARİTA KONUMU (KORPA PAZARLAMA - KAYSERİ OSB)
  // Coordinates match the Footer component
  const mapCoords = "38.717503,35.3395059";
  // &iwloc=A adds the info window for the first result
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              ...
              <div className="bg-white p-6 rounded-xl shadow-sm border border-gray-100 flex items-start space-x-4">
                ...
                <div>
                  ...
                  <p className="text-sm text-gray-600">korpa@hemaks.com</p>
                </div>
              </div>
            </div>
